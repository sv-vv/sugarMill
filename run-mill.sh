...
function fixup_instance_code() {
    ...
    # Make sure config_override.php exists before appending PHP code to it
    # (it is a PHP file and it must start with the "<?php" PHP marker)
    [ -f "$DEST/config_override.php" ] || echo -e "<?php // Generated by sugarMill \n" >> "$DEST/config_override.php"
